...
local connectedPlayers, maxPlayers, All_Data = 0, GetConvarInt('sv_maxclients', 128), {}
...
ESX.RegisterServerCallback('leon_scoreboard:get_all_data', function(source, cb)
